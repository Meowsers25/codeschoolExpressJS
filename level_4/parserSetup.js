...
On the bodyParser object, call a function that returns a parser
for URL encoded data and store it in a variable called parseUrlencoded.
Remember to pass in an option which forces the use of the native
...
app.post('/cities',parseUrlencoded, function (request, response) {
  ...
  /*Read the name and description parameters from the payload of the POST
